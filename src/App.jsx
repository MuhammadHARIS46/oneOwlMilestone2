      ...
      <Routes>
        ...
        <Route element={<Layout />}>
          <Route
            ...
            element={<Dashboard />}
            onEnter={() =>
              trackEvent("pageview", "Dashboard View", "Dashboard")
            }
          />
          <Route
            ...
            onEnter={() =>
              trackEvent("pageview", "Communication View", "Communication")
            }
          />
          <Route
            path={ROUTES.FAQ}
            element={<Faq />}
            onEnter={() => trackEvent("pageview", "FAQ View", "FAQ")}
          />
          <Route
            path={ROUTES.PREFERENCE}
            element={<Prefernce />}
            onEnter={() =>
              trackEvent("pageview", "Preference View", "Preference")
            }
          />
          <Route
            path={ROUTES.BILLING}
            element={<Billing />}
            onEnter={() => trackEvent("pageview", "Billing View", "Billing")}
          />
          <Route
            path={ROUTES.NOTIFICATION}
            element={<Notification />}
            onEnter={() => trackEvent("pageview", "pageview", "Notification")}
          />
          <Route
            path={ROUTES.SETTINGS}
            element={<Settings getThemeColor={getThemeColor} />}
            onEnter={() => trackEvent("pageview", "Settings View", "Settings")}
          />
          <Route
            path={ROUTES.PROFILE}
            element={
              <Profile
                getUserNameVal={getUserNameVal}
                getUserLastVal={getUserLastVal}
              />
            }
            onEnter={() => trackEvent("pageview", "Profile View", "Profile")}
          />
          ...
          <Route
            ...
            onEnter={() =>
              trackEvent("pageview", "DashboardAgent View", "DashboardAgent")
            }
          />
          <Route
            path={ROUTES.SERVICE}
            element={<Service />}
            onEnter={() => trackEvent("pageview", "Service View", "Service")}
          />
          <Route
            path={ROUTES.PERFORMANCE}
            element={<Performance />}
            onEnter={() =>
              trackEvent("pageview", "Performance View", "Performance")
            }
          />
          <Route
            ...
            element={<Compliance />}
            onEnter={() =>
              trackEvent("pageview", "Compliance View", "Compliance")
            }
          />
          <Route
            path={ROUTES.WORKFLOW}
            element={<Workflow />}
            onEnter={() => trackEvent("pageview", "Workflow View", "Workflow")}
          />
          ...
          <Route
            ...
            onEnter={() =>
              trackEvent("pageview", "DashboardAdmin View", "dashboardAdmin")
            }
          />
          <Route
            ...
            onEnter={() =>
              trackEvent("pageview", "AdminCompliance View", "AdminCompliance")
            }
          />
          <Route
            ...
            element={<Channel />}
            onEnter={() =>
              trackEvent("pageview", "UserManagement View", "UserManagement")
            }
          />
          <Route
          ...
          <Route
            path={ROUTES.PRIVACY}
            element={<Privacy />}
            onEnter={() => trackEvent("pageview", "Privacy View", "Privacy")}
          />
        </Route>
      </Routes>
    </React.Fragment>
