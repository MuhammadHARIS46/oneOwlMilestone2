...
export const Notification = () => {
  ...
  const deleteMyNotification = async (id) => {
    try {
        ...
        <div className="notificationComponent">
          ...
          {displayedItems.map((item, keyId) => (
            <div className="mainListComp" key={keyId}>
              ...
              <div className="mainListPara">{item.notificationBody}</div>
      ...
      {isLogoutModalOpen && (
        <dialog id="modalNotification" className="modalLogout" open>
          <div className="modalLogoutMain">
            ...
            <p className="headerNotify">
              {" "}
              <AiOutlineWarning /> {selectedItemHeader}
            </p>
